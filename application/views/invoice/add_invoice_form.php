                            ...
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center"><?php echo display('dove')?></th>
                                         <th class="text-center"><?php echo display('packet')?></th>
                                ...
                                <tbody id="addinvoiceItem">
                                    <tr>
                                        <td class="product_field">
                                          ...
                                          <td>
                                            <input type="text" name="dove[]" class="form-control text-right" placeholder="0.00" tabindex="6"/>
                                        </td>
                                          <td>
                                            <input type="text" name="pkt[]" class="form-control text-right" placeholder="0.00"  tabindex="7"/>
                                        </td>
                                        <td>
