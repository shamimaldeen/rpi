...
<aside class="main-sidebar">
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <?php if ($this->permission1->method('dateWiseInvoice', 'read')->access()) { ?>
                <li class="treeview <?php
                if ($this->uri->segment('2') == ("dateWiseInvoice")) {
                    echo "active";
                } else {
                    echo " ";
                }
                ?>">
                    <a href="<?php echo base_url('Cinvoice/dateWiseInvoice') ?>"><?php echo display('datewise_invoice') ?></a>
                </li>
            <?php } ?>
...
<?php } ?>
            ...
            ?>">
             ...
             <?php if($this->permission1->method('sales_report_category_wise','read')->access()){ ?>
                ...
                <?php if ($this->permission1->method('salary_sheet_dateWise', 'read')->access()) { ?>
                    <li class="treeview <?php if ($this->uri->segment('2') == ("salary_sheet_dateWise")) {
                        echo "active";
                    } else {
                        echo " ";
                    } ?>">
                    <a href="<?php echo base_url('Creport/salary_sheet_dateWise') ?>"><?php echo display('salary_sheet') ?></a>
                    </li>
                <?php } ?>
                </ul>
            </li>
            ...
            ?>">
                ...
                <ul class="treeview-menu">
                    <?php if($this->permission1->method('add_advance','create')->access()){ ?>
                      <li class="treeview <?php if ($this->uri->segment('2') == ("add_advance")){
                        echo "active";
                    } else {
                        echo " ";
                    }?>"><a href="<?php echo base_url('Csettings/add_advance') ?>">
                        <?php echo display('add_advance') ?></a></li><?php }?>
            <?php if($this->permission1->method('manage_advance_salary','read')->access()){ ?>
                      <li class="treeview <?php if ($this->uri->segment('2') == ("manage_advance_salary")){
                        echo "active";
                    } else {
                        echo " ";
                    }?>"><a href="<?php echo base_url('Csettings/manage_advance_salary') ?>"><?php echo display('manage_advance_salary') ?></a></li>
                      <?php }?>
